...
urlpatterns = [
    ...
    path('dashboard/order-report/', views.OrderReportView.as_view(), name='order_report'),
    path('dashboard/generate-product-report/', views.GenerateProductReportView.as_view(), name='generate_product_report'),
    path('dashboard/generate-stock-report/', views.GenerateStockReportView.as_view(), name='generate_stock_report'),
    path('dashboard/export-delivery-history/', views.DeliveryHistoryReportView.as_view(), name='export_delivery_history'),
    path('export-revenue/', views.TotalRevenueReportView.as_view(), name='export_revenue'),
    path('report/user/', views.UserReportView.as_view(), name='user_report'),
